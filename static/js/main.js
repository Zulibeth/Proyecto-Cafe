...
if (form) {
  form.addEventListener("submit", function (e) {
    ...
    alert(
      `¡Gracias por tu mensaje, ${nombre}! Pronto nos pondremos en contacto contigo ☕`
    );
    form.reset();
  });
}
...
async function fetchPrices() {
  try {
    ...
    document.getElementById("precio-altura").textContent =
      data["Café Altura - Brasil Peru (250g)"];
    document.getElementById("precio-mandrake").textContent =
      data["Café Mandrake - Blend Espresso (1kg)"];
    document.getElementById("precio-dLara").textContent =
      data["D'Lara - Blend Saphire El Salvador (250g)"];
  } catch (e) {
...
const images = [
  "static/assets/img/granos-cafe.jpg",
  "static/assets/img/burbujas-cafe.jpg",
  "static/assets/img/latte-cafe.jpg",
  "static/assets/img/verde-cafe.jpg",
];
